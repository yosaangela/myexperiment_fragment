var themeName = "toloomid"; // Edit according to your theme slug/name if needed.

var myConfig = require("./_config.js");
...
var browserSyncOption = {
	...
	config: {
		watchTask: true,
		proxy: myConfig ? myConfig : "http://localhost/" + themeName + "/"
...
var config = {
	...
	get sassPlugin() {
		return [
			...
			// Hamburger
			this.nodeDir + "/hamburgers/_sass/hamburgers"
		];
	}
};
