<?php
/**
 * YourThemeName functions and definitions
 *
...
if ( ! function_exists( 'YourThemeName_setup' ) ) :
	...
	function YourThemeName_setup() {
		 ...
		 * If you're building a theme based on YourThemeName, use a find and replace
		 * to change 'YourThemeName' to the name of your theme in all the template files.
		 */
		...
		register_nav_menus( array(
			'primary' => esc_html__( 'Primary', 'YourThemeName' )
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'YourThemeName_custom_background_args', array(
...
function YourThemeName_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'YourThemeName' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'YourThemeName' ),
 ...
 * Register CPT jobs
 */
require get_template_directory() . '/inc/register-cpt-book.php';
